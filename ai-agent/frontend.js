...
class AIJobMatcher {
    ...
    bindEvents() {
        ...
        this.analyzeResumeBtn.addEventListener('click', () => this.analyzeResume());
        this.startSearchBtn.addEventListener('click', () => this.startJobSearch());
        ...
        this.timezoneFilter.addEventListener('change', () => this.applyFilters());

        // Load more functionality
        this.loadMore.addEventListener('click', () => this.loadMoreJobs());
    }
